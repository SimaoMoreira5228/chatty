	...
	fn ingest_from_normalized_chat(
		...
		let mut ingest = IngestEvent::new(
			...
			IngestPayload::ChatMessage(ChatMessage {
				...
				text: n.text,
				reply: n.reply.map(|reply| crate::ChatReply {
					server_message_id: None,
					platform_message_id: Some(reply.parent_message_id),
					user_id: Some(reply.parent_user_id),
					user_login: reply.parent_user_login,
					user_display: Some(reply.parent_user_name),
